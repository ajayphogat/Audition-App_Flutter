                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: screenHeight * 0.02),
                      AutoSizeText(
                        "You are currently using the monthly premium plan expiring on 29 March 2023. Upgrade your subscription plan to continue using the app.",
                        maxFontSize: 12,
                        minFontSize: 10,
                        style: TextStyle(
                          fontSize: 12,
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                            left: screenWidth * 0.02, right: screenWidth * 0.4),
                        child: Column(
                          children: [
                            Row(
